...
export default {
  'common': {
    'labels': {
      ...
      'wallet-broadcast-error':
        'There was an error while broadcasting the transaction. Please try again.',
      'network-error':
        'Something is temporary wrong with your network connection or our services. Please try again later.',
